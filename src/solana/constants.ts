export const STAKE_TOKEN_DECIMALS = 9;
export const STAKE_TOKEN_MINT = "Hz1XePA2vukqFBcf9P7VJ3AsMKoTXyPn3s21dNvGrHnd";
export const PROGRAM_ID = "9Ef7uzrdsFCjb3jCqR9YERTKAKnmpxj8QMRGKED1Csq5";
export const CONTRACT_TOKEN_ACCOUNT =
  "Fvf4rtnE4Vt36VMqDQ8PueQf3zJRcThAz4Nw4nc2eXhV";
